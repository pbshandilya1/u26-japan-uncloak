...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        const redirectUrl = "https://goldfish-app-e2vh6.ondigitalocean.app/";
...
<a href="https://goldfish-app-e2vh6.ondigitalocean.app/" id="accept-cookies" class="btn-primary">同意する</a>
</div>
        `;
